...
do
    ...
    do
        if [ $CASE_NUM -eq "1" ]; then
            cat data/capture/ver3/simulate/USE_NUM/data_${USE_NUM}_${CASE_NUM}_${D}.csv| python identifyMethod.py timeDiff ${USE_NUM} ${CASE_NUM} ${D}> data/result/evaluation/ver3/case/USE_NUM/timeDiff_${USE_NUM}_${D}.csv &
            cat data/capture/ver3/simulate/USE_NUM/data_${USE_NUM}_${CASE_NUM}_${D}.csv| python identifyMethod.py liner ${USE_NUM} ${CASE_NUM} ${D}> data/result/evaluation/ver3/case/USE_NUM/liner_${USE_NUM}_${D}.csv &
            cat data/capture/ver3/simulate/USE_NUM/data_${USE_NUM}_${CASE_NUM}_${D}.csv| python identifyMethod.py combine_liner_dist 0.14 1 ${USE_NUM} ${CASE_NUM} ${D}> data/result/evaluation/ver3/case/USE_NUM/combine_liner_dist_${USE_NUM}_${D}.csv
        else
            cat data/capture/ver3/simulate/USE_NUM/data_${USE_NUM}_${CASE_NUM}_${D}.csv| python identifyMethod.py timeDiff ${USE_NUM} ${CASE_NUM} ${D}>> data/result/evaluation/ver3/case/USE_NUM/timeDiff_${USE_NUM}_${D}.csv &
            cat data/capture/ver3/simulate/USE_NUM/data_${USE_NUM}_${CASE_NUM}_${D}.csv| python identifyMethod.py liner ${USE_NUM} ${CASE_NUM} ${D}>> data/result/evaluation/ver3/case/USE_NUM/liner_${USE_NUM}_${D}.csv &
            cat data/capture/ver3/simulate/USE_NUM/data_${USE_NUM}_${CASE_NUM}_${D}.csv| python identifyMethod.py combine_liner_dist 0.14 1 ${USE_NUM} ${CASE_NUM} ${D}>> data/result/evaluation/ver3/case/USE_NUM/combine_liner_dist_${USE_NUM}_${D}.csv
